### Введение
    ...
    Мне всегда было интересно можно ли собирать домашнии компьютеры не только либо для игр или для работы, а для чего-то еще ?
    ...
    Результат работы скрипта: Artificial intelligence.ipynb сохраню в виде csv-файла и потроим график.
